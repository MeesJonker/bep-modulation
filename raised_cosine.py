...
# raised cosine implementation from the book
# Digital Modulations using Python by Mathuranathan Viswanathan
def raised_cosine_design(alpha, span, L):
    """
...
def raised_cosine(data, alpha, span, L):
    rc = raised_cosine_design(alpha, span, L)
    return np.convolve(data, rc, mode='full')
